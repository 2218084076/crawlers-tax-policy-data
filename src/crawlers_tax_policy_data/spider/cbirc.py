"""
银保监会
http://www.cbirc.gov.cn/cn/view/pages/zhengwuxinxi/zhengfuxinxi.html?signIndex=4#1
分类采集：
    - 行政规范性文件  tag 标签位置 //span[@item="4215"]
    - 其他文件       tag 标签位置 //span[@item="4216"]
"""
import asyncio
import re
...
class CbircSpider(BaseSpider):
    ...
    def url(self):
        ...
        :return:
        """
        return 'http://www.cbirc.gov.cn/cn/view/pages/zhengwuxinxi/zhengfuxinxi.html?signIndex=4#1'
